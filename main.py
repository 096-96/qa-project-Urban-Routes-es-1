...
class UrbanRoutesPage:
    ...
    def click_on_button_add_popup_window(
            self):  # Código para dar click al botón "Agregar" del formulario para agregar tarjeta
    ...
    def get_button_close_add_payment_window(
            self):  # Código para obtener el botón "Cerrar" de la ventana para agregar el metodo de pago
...
class TestUrbanRoutes:
    ...
    def test_set_phone_number (self): #Código para agregar número de teléfono
    ...
    def test_set_select_payment_method(self): #Código para agregar una tarjeta
        self.test_select_comfort_rate()
        routes_page = UrbanRoutesPage(self.driver)
